...
public class TelaEquipamentos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Produtos pré cadastrados");
        ...
        jPanel1.add(lblFechar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 10, 50, 40));
        ...
        jLabel6.setText("Descrição, fornecedor");
        jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 130, 230, -1));
        ...
        jPanel1.add(btnEstoque, new org.netbeans.lib.awtextra.AbsoluteConstraints(1070, 420, 70, 60));
        ...
        setSize(new java.awt.Dimension(1170, 641));
    ...
    private void btnEstoqueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEstoqueActionPerformed
        String equip = String.valueOf(tabela.getValueAt(tabela.getSelectedRow(), 0));
        new CadastroEstoqueEquipamento(equip).setVisible(true);
        this.dispose();;
    ...
    private void filtrar() {
        ...
        equipamentos = new EquipamentoController().filtrar(txtFiltro.getText().toUpperCase());
        ((DefaultTableModel) tabela.getModel()).setRowCount(0);
        ((DefaultTableModel) tabela.getModel()).setColumnCount(6);
        String[] header = {"Descrição", "Garantia", "Fabricação", "Fornecedor", "Valor", "Tipo"};
        ...
        for (Equipamento c : equipamentos) {
            ...
            dados[0] = c.getDescricao();
            dados[1] = c.getGarantia() + " Meses";
            dados[2] = dataBrasil.format(c.getDataFabricacao());
            dados[3] = c.getFornecedor().getNome();
            dados[4] = f.format(c.getValor());
            dados[5] = c.getTipo().getTipo();
     ...
     private void listar() {
        List<Equipamento> equipamentos;
        equipamentos = new EquipamentoController().listar();
        ((DefaultTableModel) tabela.getModel()).setRowCount(0);
        ((DefaultTableModel) tabela.getModel()).setColumnCount(6);
        String[] header = {"Descrição", "Garantia", "Fabricação", "Fornecedor", "Valor", "Tipo"};
        ((DefaultTableModel) tabela.getModel()).setColumnIdentifiers(header);
