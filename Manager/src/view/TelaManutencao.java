...
public class TelaManutencao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Equipamentos em manutenção");
        ...
        jLabel6.setText("Equipamento, defeito");
        ...
        btnEstoque.setFont(new java.awt.Font("Nirmala UI", 0, 14)); // NOI18N
        btnEstoque.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/img/equipamentos.png"))); // NOI18N
        ...
        jPanel1.add(btnEstoque, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 320, 70, 60));
        ...
        setSize(new java.awt.Dimension(1138, 696));
    ...
    private void txtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFiltroKeyReleased
        txtDataInicial.setDateFormatString("");
        txtDataFinal.setDateFormatString("");
    ...
    private void preencher() {
        List<EquipamentoEmManutencao> equipamentos;
        equipamentos = new ManutencaoController().listar();
        ((DefaultTableModel) tabela.getModel()).setRowCount(0);
        ((DefaultTableModel) tabela.getModel()).setColumnCount(4);
        String[] header = {"Equipamento", "Defeito", "Quantidade", "Data da entrada"};
        ...
        for (EquipamentoEmManutencao e : equipamentos) {
            String[] dados = new String[4];
            dados[0] = e.getEquipamento().getDescricao();
            dados[1] = e.getDefeito();
            dados[2] = e.getQtd() + "";
            dados[3] = dataBrasil.format(e.getDataEntrada());
     ...
     private void filtrar(String filtro) {
        List<EquipamentoEmManutencao> equipamentos;
        equipamentos = new ManutencaoController().listar(filtro.toUpperCase());
        ((DefaultTableModel) tabela.getModel()).setRowCount(0);
        ((DefaultTableModel) tabela.getModel()).setColumnCount(4);
        String[] header = {"Equipamento", "Defeito", "Quantidade", "Data da entrada"};
        ((DefaultTableModel) tabela.getModel()).setColumnIdentifiers(header);
    ...
    private void filtraByData(Date inicio, Date fim) {
         List<EquipamentoEmManutencao> equipamentos;
        equipamentos = new ManutencaoController().filtraByData(inicio, fim);
